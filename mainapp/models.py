...
class CategoryManager(models.Manager):
    ...
    def get_categories_for_left_sidebar(self):
        models = get_models_for_count('sneakers', 'tshirt')
...
class LatestProductsManager:
    ...
    # достает весь список товаров, который отображается на главной странице
    @staticmethod
    def get_main_page_products(*args, **kwargs):
        products = []
...
class Tshirt(Product):
    size_tshirt = models.CharField(max_length=255, verbose_name='Размер футболки')
...
class Sneakers(Product):
    size_sneakers = models.CharField(max_length=255, verbose_name='Размер кросовок')
    brand_name = models.CharField(max_length=255, verbose_name='Бренд')
